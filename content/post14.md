...
La *signature* ou *empreinte* d'un fichier est une séquence de caractères associée de façon unique à ce fichier. Par exemple, l'empreinte du fichier **mon_authentique_photo.png** peut être *f6c51c6bb1ce72508313dad3dc3c6776*. Toute modification, même minime du fichier entraînera une modification de l'empreinte.   
Cette prouesse est réalisée à l'aide des [fonctions de hachage](https://fr.wikipedia.org/wiki/Fonction_de_hachage). Les algorithmes [MD5](https://fr.wikipedia.org/wiki/MD5) et [SHA-1](https://fr.wikipedia.org/wiki/SHA-1) sont certainement les plus connus.    
Depuis un terminal [Unix](https://fr.wikipedia.org/wiki/Unix), l'empreinte de n'importe quel fichier peut être récupérée en tapant : 
