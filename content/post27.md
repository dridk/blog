Title: Séquençage des ARNm sur cellules uniques 
Slug: sc-rna-seq
...
L'idée est de créer une [librairie](ngs.html) (Ensemble des fragments d'ADN destinés au séquençage) où chaque ARNm se voit greffer une séquence identifiant sa cellule d'origine ([barcode](https://fr.wikipedia.org/wiki/Barcoding_mol%C3%A9culaire)). On peut alors, après séquençage, regrouper les [reads](https://dridk.me/ngs.html) entre eux grâce à leurs barcodes et obtenir une matrice d'expression par cellules et par gènes.   
