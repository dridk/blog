...
L'inférence bayésienne permet de donner ici une probabilité aux causes à partir des leurs effets observés. Et chaque jour, sans le savoir, nous faisons de l'inférence. Selon les disciplines, les causes sont appelées des théories, des modèles statistiques, des fonctions mathématiques, des hypothèses ou n'importe quelles croyances capables de faire des prédictions. Les effets quant à eux seront toujours des données observés.         
